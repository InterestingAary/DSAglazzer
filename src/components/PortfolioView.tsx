    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {projects.map((project) => (
          ...
          >
            <div className="h-20 rounded-lg mb-3 flex items-center justify-center bg-[var(--color-surface-elevated)] border border-[var(--color-border)]">
            ...
            <div className="flex flex-wrap gap-1.5 mb-3">
              {project.tech.map((tag) => (
                <span
                  key={tag}
                  className="text-[9px] uppercase font-semibold rounded-md bg-[var(--color-surface-elevated)] border border-[var(--color-border)] px-2 py-0.5 text-[var(--color-text-secondary)]"
                >
                  {tag}
                </span>
              ))}
      ...
      <motion.div
        className="card p-5 noise-overlay"
        initial={{ opacity: 0, y: 12 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <div className="bg-[var(--color-surface-elevated)] rounded-lg overflow-hidden p-4 relative z-10 border border-[var(--color-border)]">
