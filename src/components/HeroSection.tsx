...
export const HeroSection: React.FC<HeroSectionProps> = ({ userStats }) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-accent)]/5 via-transparent to-[var(--color-accent-secondary)]/3 opacity-50" />
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
        <div className="flex flex-col gap-5 max-w-2xl">
          ...
          <motion.div
            className="flex flex-wrap items-center gap-4 sm:gap-6 pt-4 border-t border-[var(--color-border)]"
            initial={{ opacity: 0, y: 8 }}
            animate={{ opacity: 1, y: 0 }}
