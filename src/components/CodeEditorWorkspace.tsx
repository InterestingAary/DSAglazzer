      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            {activeTestTab === 'description' ? (
              <div className="space-y-4">
                ...
                {problem.examples.map((ex, idx) => (
                  <div key={idx} className="bg-[var(--color-surface-elevated)] rounded-xl p-3 border border-[var(--color-border)]">
                ...
                <AnimatePresence>
                  {showHints && (
                    ...
                    >
                      <div className="bg-[var(--color-surface-elevated)] rounded-xl p-3 space-y-2 border border-[var(--color-border)]">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="bg-[var(--color-surface-elevated)] rounded-xl overflow-hidden border border-[var(--color-border)]" style={{ minHeight: '400px' }}>
              <CodeMirror
                value={code}
                height="400px"
                theme={oneDark}
